 ...
 */
@AnalyzeClasses(packages = "com.bewi.stockmanager.marketdata",
        importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {

    @ArchTest
    static final ArchRule theHexagonPointsInwards = layeredArchitecture().consideringOnlyDependenciesInLayers()
            .layer("Domain").definedBy("com.bewi.stockmanager.marketdata.domain..")
            .layer("Application").definedBy("com.bewi.stockmanager.marketdata.application..")
            .layer("Adapters").definedBy("com.bewi.stockmanager.marketdata.adapter..")
            .layer("Configuration").definedBy("com.bewi.stockmanager.marketdata.config..",
                    "com.bewi.stockmanager.marketdata")
    ...
    static final ArchRule theApplicationLayerKnowsNoFramework = noClasses()
            .that().resideInAPackage("..marketdata.application..")
            .should().dependOnClassesThat().resideInAnyPackage(
                    "org.springframework..", "jakarta.persistence..", "com.fasterxml..", "tools.jackson..",
                    "org.hibernate..")
    ...
    static final ArchRule useCasesAreReachedThroughPorts = noClasses()
            .that().resideInAPackage("..marketdata.adapter.in..")
            .should().dependOnClassesThat().resideInAPackage("..marketdata.application.service..")
    ...
    static final ArchRule nothingReachesIntoTheOtherSelfContainedSystem = noClasses()
            .that().resideInAPackage("com.bewi.stockmanager.marketdata..")
            .should().dependOnClassesThat().resideInAPackage("com.bewi.stockmanager.portfolio..")
    ...
    static final ArchRule thereAreNoCycles = slices()
            .matching("com.bewi.stockmanager.marketdata.(*)..")
    ...
    static final ArchRule repositoriesAreDomainPorts = classes()
            ...
            .should().beInterfaces()
            .andShould().resideInAPackage("..marketdata.domain..")
